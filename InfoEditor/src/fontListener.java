...
class fontListener implements ActionListener {
	...
	public fontListener(JMenuBar menubar1,JToolBar toolBar1 ,JPanel contents1, JTextPane editorText1, JComboBox<String> COLORCHG1) {
		menuBar = menubar1;
		toolBar = toolBar1; 
		contents = contents1;
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		System.out.println("command = " + e.getActionCommand() + " asf ");
		
		if (e.getActionCommand().equals("Search")) {
			System.out.println(" hiii ");
			highlighter = editorText.getHighlighter();
			
			String searchFor = JOptionPane.showInputDialog("Enter what you would like to search for:");
			String currentText = editorText.getText();
			System.out.println(" searchfor text is: " + searchFor);
					...
					if (selectedOption == JOptionPane.OK_OPTION) {
						if (currentText.substring(endSelect,
							...
							selectedOption = JOptionPane.showOptionDialog(null,
									...
									null, null);
							searchMore = true;
							String restOf = currentText.substring(endSelect,
									currentText.length());
		...
		if (e.getActionCommand().equals("Create a table")) {
		...
		if (e.getActionCommand().equals("Size Up")) {
			fontSize = (fontSize + 2);
		}

		// Determine which size font is selected.
		if (e.getActionCommand().equals("size8")) {
			fontSize = 8;
		}
		if (e.getActionCommand().equals("size9")) {
			fontSize = 9;
		}
		if (e.getActionCommand().equals("size10")) {
			fontSize = 10;
		}
		if (e.getActionCommand().equals("size11")) {
			fontSize = 11;
		}
		if (e.getActionCommand().equals("size12")) {
			fontSize = 12;
		}
		if (e.getActionCommand().equals("size24")) {
			fontSize = 24;
		if (e.getActionCommand().equals("size36")) {
			fontSize = 36;
		}
		if (e.getActionCommand().equals("size72")) {
			fontSize = 72;
		}
		if (e.getActionCommand().equals("size96")) {
			fontSize = 96;
		}
		}

		if (e.getActionCommand().equals("leftAlign")) {
		...
		if (e.getActionCommand().equals("ALleft")) {
		...
		if (e.getActionCommand().equals("centerAlign")) {
		...
		if (e.getActionCommand().equals("ALcenter")) {
			TabStop[] tab = new TabStop[1];
			tab[0] = new TabStop((contents.getWidth() / 2),
					TabStop.ALIGN_CENTER, TabStop.LEAD_NONE);
			TabSet tabset = new TabSet(tab);
		...
		if (e.getActionCommand().equals("rightAlign")) {
		...
		if (e.getActionCommand().equals("ALright")) {
